...
Reusability of code is the use of existing software, or software knowledge,Actors to build new software (ref. https://en.wikipedia.org/wiki/Code_reuse). This is of course the fundamental idea with library. I just hope the library has the quality that is needed to be used over and over again in many projects.
...
* State machines<br>State machines are part of nearly all systems. However, they come in many variants/implementations and it is always complicated to understand how they work and what they do. A new approach to state machines will be presented in this library. The implementayion will be very close to the definition of a state machine.

* Behavir Trees<br>Experimental feature that will be added to the library.

* Reactive programming<br>Although reactive programming has nothing to do with reactive systems, it is intereting to take another view of the Actors model. In stead of looking at the Actors model a 
...
The second phase is only related to create a distributed system of Actors that can execute on multiple platforms and hosts.
